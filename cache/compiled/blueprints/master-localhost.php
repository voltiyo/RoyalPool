...
return [
    ...
    'timestamp' => 1748088013,
    'checksum' => 'a396f7a32a92129814dcc1e8c8ea83f0',
    'files' => [
    ...
    'data' => [
        'items' => [
            ...
            'themes.quark.footer_location_link' => [
                'type' => 'text',
                'label' => 'Google Maps Location',
                'name' => 'themes.quark.footer_location_link',
                'validation' => 'loose'
            ],
            'themes.quark.Contact_address' => [
                'type' => 'textarea',
                'label' => 'Address',
                'name' => 'themes.quark.Contact_address',
                'validation' => 'loose'
            ],
            'themes.quark.Phone_number' => [
                'type' => 'text',
                'label' => 'Phone Number',
                'name' => 'themes.quark.Phone_number',
                'validation' => 'loose'
            ],
            'themes.quark.Whatsapp_number' => [
                'type' => 'text',
                'label' => 'Whatsapp Number',
                'name' => 'themes.quark.Whatsapp_number',
                'validation' => 'loose'
            ],
            'themes.quark.Email' => [
                'type' => 'text',
                'label' => 'Email',
                'name' => 'themes.quark.Email',
                'validation' => 'loose'
            ],
            'themes.quark.facebook_link' => [
                'type' => 'text',
                'label' => 'Facebook redirect link',
                'name' => 'themes.quark.facebook_link',
                'validation' => 'loose'
            ],
            'themes.quark.twitter_link' => [
                'type' => 'text',
                'label' => 'Twitter redirect link',
                'name' => 'themes.quark.twitter_link',
                'validation' => 'loose'
            ],
            'themes.quark.youtube_link' => [
                'type' => 'text',
                'label' => 'Youtube redirect link',
                'name' => 'themes.quark.youtube_link',
                'validation' => 'loose'
            ],
            'themes.quark.instagram_link' => [
                'type' => 'text',
                'label' => 'Instagram redirect link',
                'name' => 'themes.quark.instagram_link',
                'validation' => 'loose'
            ],
            'themes.quark.linkedin_link' => [
                'type' => 'text',
                'label' => 'Linkedin redirect link',
                'name' => 'themes.quark.linkedin_link',
                'validation' => 'loose'
            ],
            'themes.quark.brochure' => [
                'array' => true,
                'media_field' => true,
                'validate' => [
                    'type' => 'ignore'
                ...
                'multiple' => false,
                'markdown' => true,
                'description' => 'will be downloaded in the website',
                'accept' => [
                    0 => 'application/*'
                ],
                'name' => 'themes.quark.brochure',
                'validation' => 'loose'
            ],
        ...
        'nested' => [
            ...
            'themes' => [
                'quark' => [
                    ...
                    'footer_location_link' => 'themes.quark.footer_location_link',
                    'Contact_address' => 'themes.quark.Contact_address',
                    'Phone_number' => 'themes.quark.Phone_number',
                    'Whatsapp_number' => 'themes.quark.Whatsapp_number',
                    'Email' => 'themes.quark.Email',
                    'facebook_link' => 'themes.quark.facebook_link',
                    'twitter_link' => 'themes.quark.twitter_link',
                    'youtube_link' => 'themes.quark.youtube_link',
                    'instagram_link' => 'themes.quark.instagram_link',
                    'linkedin_link' => 'themes.quark.linkedin_link',
                    'brochure' => 'themes.quark.brochure',
