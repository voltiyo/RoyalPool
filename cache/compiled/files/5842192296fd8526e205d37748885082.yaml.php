        ...
        'form' => [
            ...
            'fields' => [
                ...
                'footer_location_link' => [
                    ...
                    'help' => 'Enter The google maps embed link to show the location in the footer'
                ],
                'Contact_address' => [
                    'type' => 'textarea',
                    'label' => 'Address',
                    'help' => 'Enter The address to be shown on the website'
                ],
                'Phone_number' => [
                    'type' => 'text',
                    'label' => 'Phone Number',
                ...
                'Whatsapp_number' => [
                    ...
                    'help' => 'Enter The Whatsapp Number'
                ],
                'Email' => [
                    'type' => 'text',
                    'label' => 'Email',
                ...
                'facebook_link' => [
                    ...
                    'help' => 'Enter facebook page\'s link'
                ],
                'twitter_link' => [
                    'type' => 'text',
                    'label' => 'Twitter redirect link',
                    'help' => 'Enter twitter page\'s link'
                ],
                'youtube_link' => [
                    'type' => 'text',
                    'label' => 'Youtube redirect link',
                    'help' => 'Enter Youtube page\'s link'
                ],
                'instagram_link' => [
                    'type' => 'text',
                    'label' => 'Instagram redirect link',
                    'help' => 'Enter instagram page\'s link'
                ],
                'linkedin_link' => [
                    'type' => 'text',
                    'label' => 'Linkedin redirect link',
                    'help' => 'Enter Linkedin page\'s link'
                ],
                'brochure' => [
                    'type' => 'file',
